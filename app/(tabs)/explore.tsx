...
function criarEstilos(cores: Cores) {
  return StyleSheet.create({
    ...
    produtoImagem: { width: 72, height: 72, borderRadius: 10, backgroundColor: cores.fundoCartao },
    produtoImagemVazia: { justifyContent: 'center', alignItems: 'center' },
    produtoImagemVaziaTexto: { fontSize: 11, color: cores.textoSecundario, textAlign: 'center' },
